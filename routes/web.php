...
Route::get('/guru/course/list-materi', [CourseController::class, 'index'])
    ->name('course.index');
...
Route::middleware(['auth'])->group(function () {
    Route::get('/guru/nilai/daftarNilai', [GradingController::class, 'index'])->name('grading.index');
    Route::get('/grading/detail/{userId}', [GradingController::class, 'show'])->name('grading.show');
    ...
    Route::get('/siswa/nilaiSiswa/hasilBelajar', [StudentGradeController::class, 'index'])->name('siswa.hasil.index');
...
Route::middleware(['auth'])->group(function () {
    Route::get('/siswa/courseSiswa/listCourse', [CourseSiswaController::class, 'index'])
